                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Accede a la lista de clientes.</p>
                                    <a href="customerviews/showCustomer.php" class="btn btn-primary">Ir a Clientes</a>
                                </div>
                            </div>
                        </div>
                        <li>
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    ...
                                    <p class="card-text">Accede a la lista de productos.</p>
                                    <a href="productsViews/showProducts.php" class="btn btn-primary">Ir a Productos</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <h5 class="card-title">Ver mi tienda</h5>
                                    <p class="card-text">Accede a la tienda.</p>
